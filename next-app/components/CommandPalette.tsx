...
import { SHORTCUTS_OPEN_EVENT } from "@/components/KeyboardShortcutsDialog";
...
export default function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => {
    const items: CommandItem[] = [
      ...
      { id: "nav.notifications", label: "Go to Notifications", href: "/notifications" },
      {
        id: "ui.shortcuts",
        label: "Keyboard shortcuts",
        keywords: ["help", "keys", "hotkey"],
        action: () => window.dispatchEvent(new CustomEvent(SHORTCUTS_OPEN_EVENT)),
        hint: "?",
      },
                    ...
                    <li key={`user:${username}`}>
                      <button
                        ...
                        onClick={() => {
                          setOpen(false);
                          setQuery("");
                          nav.push(`/users/${encodeURIComponent(username)}`);
                        }}
                      >
                  ...
                  <li key={c.id}>
                    <button
                      ...
                      onClick={() => {
                        ...
                        else if (c.href) nav.push(c.href);
                      }}
                    >
