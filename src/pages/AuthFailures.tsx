                      ...
                      <tr key={String(r.id)} className="border-t">
                        ...
                        <td className="px-3 py-2">
                          {r.username && canOpenUsers ? (
                            <Link className="underline" to={`/users/${encodeURIComponent(r.username)}`}>{r.username}</Link>
                          ) : (
                            r.username || "-"
                          )}
                        </td>
                              ...
                              actions={[
                                ...(r.username && canOpenUsers
                                  ? [{
                                      label: "Open user",
                                      icon: ExternalLink,
                                      onClick: () => navigate(`/users/${encodeURIComponent(r.username as string)}`),
                                ...
                                ...(r.nasIp
                                  ? [{
                                      ...
                                      icon: ExternalLink,
                                      onClick: () => navigate(`/online-users?search=${encodeURIComponent(r.nasIp as string)}`),
                                    } satisfies TableRowAction]
                                  : []),
