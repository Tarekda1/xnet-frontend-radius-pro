          ...
          {showControls ? (
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  className={`text-sm px-2 py-1 rounded border ${state.view === "both" ? "bg-white/70" : "bg-transparent"}`}
                ...
                <button
                  type="button"
                  className={`text-sm px-2 py-1 rounded border ${state.view === "monthly" ? "bg-white/70" : "bg-transparent"}`}
                ...
                <button
                  type="button"
                  className={`text-sm px-2 py-1 rounded border ${state.view === "daily" ? "bg-white/70" : "bg-transparent"}`}
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="Filter…"
                  className="h-8 rounded border border-orange-200 bg-white/70 px-2 text-sm outline-none"
                />
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded border border-orange-200 bg-white/70 p-2">
